...
unsigned int nStakeMaxAge = 310 * 24 * 60 * 60;
unsigned int nModifierInterval = 4 * 60;
...
const string strMessageMagic = "Artificial_Intelligence Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	{ 
		nSubsidy = 100000000 * COIN; return nSubsidy; 
	}
...
const int DAILY_BLOCKCOUNT =  360;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Artificial_Intelligence", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "trump loves Artificial_Intelligence";
        CTransaction txNew;
        txNew.nTime = 1485698382;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		uint256 nhashMerkleRoot = uint256("5499f35a8592b4839487e21adcb8e7f65ba26d25f20e288ec2ce6e30adce98f9");
...
unsigned char pchMessageStart[4] = { 0xd1, 0xa3, 0xb4, 0xc2 };
