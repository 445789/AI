    ...
    for (int nHost = 1; nHost <= 2; nHost++)
    {
        ...
        if (nHost == 1)
        {
            ...
            pszGet = "GET / HTTP/1.1\r\n"
                     ...
                     "User-Agent: Artificial_Intelligence\r\n"
                     "Connection: close\r\n"
                     "\r\n";
...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("Artificial_Intelligence-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("Artificial_Intelligence-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("Artificial_Intelligence-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Artificial_Intelligence " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    	{"fuzzbawls.pw","ai.seed.fuzzbawls.pw"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("Artificial_Intelligence-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("Artificial_Intelligence-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("Artificial_Intelligence-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("Artificial_Intelligence-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Artificial_Intelligence is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("Artificial_Intelligence-start");
